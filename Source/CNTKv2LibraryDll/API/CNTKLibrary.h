...
namespace CNTK
{
    ...
    public:
        ...
        ///
        std::pair<std::vector<NDArrayViewPtr>, std::vector<bool>> UnpackVariableValue(const Variable& variable, bool sequenceSegmentsAllowed)
        {
        ...
        /// a new sequence or a continuation of a previous one
        ///
        std::vector<NDArrayViewPtr> UnpackVariableValue(const Variable& variable)
        {
            return UnpackVariableValue(variable, /* sequenceSegmentsAllowed = */false).first;
        }
